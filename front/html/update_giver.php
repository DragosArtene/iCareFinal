...
<br>
  ...
  <div class="main"  style="height: 600px;">
    ...
    <form class="form1" id="form">
		...
		<input class="un " id="giverFirstName" type="text" align="center" placeholder="Name">
		<input class="un " id="giverLastName" type="text" align="center" placeholder="Name">
		<input class="un " id="giverDescription" type="text" align="center" placeholder="Name">
...
$.getJSON({
        ...
        {
           $('#giverName').val(_giver.giverName);
		   ...
		   $("#phoneNumber").val(_giver.phoneNumber)
        }
