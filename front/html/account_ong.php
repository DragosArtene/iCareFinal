...
<br>
  ...
  <div class="main"  style="height: 600px;">
    ...
    <input class="un " id="ongFirstName" type="text" align="center" placeholder="First Name">
      <input class="un " id="ongLastName" type="text" align="center" placeholder="Last Name">
      <input class="un " id="ongDescription" type="text" align="center" placeholder="Description">
      <input class="un " id="username" type="text" align="center" placeholder="username">
      <input class="un " id="phoneNumber" type="text" align="center" placeholder="phoneNumber">
      <br>
      <div>
